          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="p-8">
                ...
                <blockquote className="text-gray-700 mb-6 leading-relaxed italic text-lg">&ldquo;{testimonial.quote}&rdquo;</blockquote>

                <div className="border-t border-gray-200 pt-4">
                  <div className="text-sm text-gray-600">
                    <span className="font-medium">{testimonial.department}</span>
                  </div>
